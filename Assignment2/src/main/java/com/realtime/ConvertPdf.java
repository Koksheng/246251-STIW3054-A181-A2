...
public class ConvertPdf {
    ...
    public static void readExcel(){
        try {
            FileInputStream fileInputStream=new FileInputStream("C:\\Users\\User\\IdeaProjects\\Assignment2\\ChessResult.xlsx");
    ...
    public static void convert(){
        try {
            ...
            PdfPTable table = new PdfPTable(new float[]{3, 12, 4, 4, 4, 9});//content size of pdf table
                ...
                PdfWriter.getInstance(document, new FileOutputStream("C:\\Users\\User\\IdeaProjects\\Assignment2\\ChessResult.pdf"));
                document.open();
                document.add(table);
                document.close();
